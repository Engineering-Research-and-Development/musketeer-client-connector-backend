...
Source: https://github.com/IBM/pycloudmessenger/blob/master/pycloudmessenger/ffl/abstractions.py
...
federated training, as well as for the users and tasks management side.
"""
...
class Factory():
    ...
    def _instantiate(cls, context: AbstractContext, class_name: str, base_class, *args, **kwargs):
        ...
        """
        Commented the following two lines by musketeer-team@eng.it in order to instantiate the target class 
        from another base class having the same interface
